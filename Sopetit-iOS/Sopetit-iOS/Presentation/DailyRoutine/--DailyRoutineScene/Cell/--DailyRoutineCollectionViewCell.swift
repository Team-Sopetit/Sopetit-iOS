...
final class ExDailyRoutineCollectionViewCell: UICollectionViewCell, UICollectionViewRegisterable {
...
extension ExDailyRoutineCollectionViewCell {
    ...
    func buttonTapped(_ sender: UIButton) {
        ...
        case checkBox:
            if sender.isSelected {
                ExDailyRoutineCollectionViewCell.sharedVariable-=1
            } else {
                ExDailyRoutineCollectionViewCell.sharedVariable+=1
            }
